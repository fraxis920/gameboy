...
U8G2_SSD1306_128X64_NONAME_F_HW_I2C u8g2(U8G2_R0, U8X8_PIN_NONE);   //inizializazione pin I2C
...
void Jump(Dinovalue &Dino, unsigned long &lastJumpUpdate, float &Velocity)
{
  ...
  const int jumpSpeed = 130;
  if (millis() - lastJumpUpdate < jumpSpeed) 
  { 
    return;
  }
  lastJumpUpdate = millis();
  if(Dino.state == Dinovalue::Ground) Dino.state = Dinovalue::Air;  
  if(Dino.y >= 40) 
  {
  ...
  if(Dino.JumpDirection == Dinovalue::Up) 
  {
    Dino.y-=1+Velocity; 
    Velocity -= Gravity;
  }
  ...
  if(Dino.state == Dinovalue::Air && Dino.y >= 40) Dino.state = Dinovalue::Ground;
...
void ObstacleGen(Obstacle &Cactus)
{
  if (Cactus.x == 0)
  {
    Cactus.Height = (Obstacle::HeightType)random(0, 3);
    Cactus.x = 127;
  }
  switch (Cactus.Height)
    {
      case 0: Cactus.y = 51; Cactus.HitBox[0][0] = Cactus.x; Cactus.HitBox[0][1] = Cactus.y; Cactus.HitBox[1][0] = Cactus.x+10; Cactus.HitBox[1][1] = Cactus.y+20; break;
      case 1: Cactus.y = 45; Cactus.HitBox[0][0] = Cactus.x; Cactus.HitBox[0][1] = Cactus.y; Cactus.HitBox[1][0] = Cactus.x+10; Cactus.HitBox[1][1] = Cactus.y+20; break;
      case 2: Cactus.y = 40; Cactus.HitBox[0][0] = Cactus.x; Cactus.HitBox[0][1] = Cactus.y; Cactus.HitBox[1][0] = Cactus.x+10; Cactus.HitBox[1][1] = Cactus.y+20; break;
    }
}

void ObstacleMove(Obstacle &Cactus)
{
  Cactus.x--;
  switch(Cactus.Height)
  {
    case 0:
    {
      ...
      u8g2.drawXBMP(Cactus.x, Cactus.y, 5, 9, Cactus1Bitmap);
      break;
    }
    case 1:
    {
      ...
      u8g2.drawXBMP(Cactus.x, Cactus.y, 8, 16, Cactus2Bitmap);
      break;
    }
    case 2:
    {
      ...
      u8g2.drawXBMP(Cactus.x, Cactus.y, 10, 20, Cactus2Bitmap);
      break;
    }
...
bool CeckCollision(const Obstacle &Cactus, const Dinovalue &Dino)
{
  if(Dino.HitBox[1][0] > Cactus.HitBox[0][0] && Dino.HitBox[0][0] < Cactus.HitBox[1][0] && Dino.HitBox[1][1] > Cactus.HitBox[0][1] && Dino.HitBox[0][1] < Cactus.HitBox[1][1]) return false;
  else return true;
}
void setup() 
{
